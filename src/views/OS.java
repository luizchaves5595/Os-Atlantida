...
public class OS extends JDialog {
	...
	public OS() {
		...
		txtPlaca.setBounds(160, 233, 56, 20);
		getContentPane().add(txtPlaca);
		txtPlaca.setColumns(10);

		JLabel lblNewLabel_15 = new JLabel("Marca");
		lblNewLabel_15.setBounds(360, 239, 43, 14);
		getContentPane().add(lblNewLabel_15);

		txtMarca = new JTextField();
		txtMarca.setBounds(400, 236, 56, 20);
		getContentPane().add(txtMarca);
		txtMarca.setColumns(10);

		JLabel lblNewLabel_16 = new JLabel("Modelo");
		lblNewLabel_16.setBounds(238, 236, 46, 14);
		getContentPane().add(lblNewLabel_16);

		txtModelo = new JTextField();
		txtModelo.setBounds(284, 233, 56, 20);
		...
		lblNewLabel_19.setBounds(360, 267, 31, 14);
	...
	private void pesquisarOsReleased() {
		String read5 = "select os as OS, marca as Marca, placa as Placa, status_os as Status from tbos where os like ?";
		try {
	...
	private void imprimirOs() {
		...
		try {
			...
			String relImprimirOs = "select tbos.os, date_format(tbos.data_os,'%d/%m/%Y - %H:%i'),tbclientes.nome, tbclientes.fone, tbos.servico, tbos.modelo , tbos.placa ,  tbos.forma_pagamento , tbos.valor from tbos inner join tbclientes on tbos.id= tbclientes.id where os like ?";
			try {
				Connection con = dao.conectar();
